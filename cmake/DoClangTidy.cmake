  ...
  if(CLANG_TIDY_EXE)
    if(CLANG_TIDY_ENABLE)
      ...
      set_target_properties(${target} PROPERTIES
        C_CLANG_TIDY "${CLANG_TIDY_EXE};-fix;-fix-errors;-header-filter=${CMAKE_SOURCE_DIR}/nyaruga_util"
        CXX_CLANG_TIDY "${CLANG_TIDY_EXE};-fix;-fix-errors;-header-filter=${CMAKE_SOURCE_DIR}/nyaruga_util")
      endif()
  endif()
endfunction()
